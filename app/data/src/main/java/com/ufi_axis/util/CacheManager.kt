...
class CacheManager(context: Context) {
    ...
    suspend fun saveData(data: CachedDashboardData) {
        val entity = CachedDashboardEntity(
            ...
            deviceInfoJson = data.deviceInfoJson,
            batteryInfoJson = data.batteryInfoJson,
            storageInfoJson = data.storageInfoJson,
            uptimeInfoJson = data.uptimeInfoJson
        )
        dao.insert(entity)
    }
    ...
    suspend fun getLatestData(): CachedDashboardData? {
        ...
        return CachedDashboardData(
            ...
            deviceInfoJson = entity.deviceInfoJson,
            batteryInfoJson = entity.batteryInfoJson,
            storageInfoJson = entity.storageInfoJson,
            uptimeInfoJson = entity.uptimeInfoJson
        )
    }
