...
/**
 * [DeviceRuntime.resolve] 的选型规则测试（阶段 2 批 B）。
 *
...
class DeviceRuntimeTest {
    ...
    private class FakePlugin(
        ...
        override suspend fun probe(env: ProbeEnv): Int = 0
    }
    ...
    private fun resolve(configuredId: String, normalizationEnabled: Boolean = true): DeviceRuntime =
    ...
    @Test
    fun `本批不产生 PROBED`() {
        // probe 选型是阶段 5 的 5.2。这条钉住「现在不许有代码路径返回它」。
